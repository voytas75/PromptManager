...
Updates:
  v0.17.4 - 2025-11-23 - Added Similar context menu action to surface embedding-based recommendations and a body-size sort order to spotlight verbose templates inside the GUI.
