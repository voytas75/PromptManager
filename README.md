...
- Prompt list context menu now provides an Execute action that opens the prompt body in the text workspace and immediately runs it through the configured AI backend.
