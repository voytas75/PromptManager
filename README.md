...
- Prompt chaining pipelines with CLI management (`prompt-chain-*` commands) so teams can compose sequential prompt workflows, validate inputs, and replay chains with a single command, capturing per-step history and outputs.
