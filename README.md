...
- Response Style registry stores tone/formatting presets with inline CRUD controls so operators can define reusable answer guidelines directly from the GUI.
