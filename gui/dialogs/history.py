...
class PromptVersionHistoryDialog(QDialog):
    ...
    def _build_ui(self) -> None:
        ...
        self._tab_widget.setObjectName("promptVersionHistoryTabs")
        self._body_view = QPlainTextEdit(self)
        self._body_view.setObjectName("promptVersionHistoryBodyView")
        ...
        self._current_diff_view.setObjectName("promptVersionHistoryCurrentDiffView")
