...
from .QtCore import QEvent, QObject, QPoint
from .QtGui import QColor, QTextCursor, QTextCharFormat
...
class QHBoxLayout(QLayout):
    def addWidget(self, widget: QWidget, stretch: int = ..., alignment: int | None = None) -> None: ...
