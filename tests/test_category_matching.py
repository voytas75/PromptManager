...
from gui.main_window import match_category_label
...
def test_match_category_label_exact_label() -> None:
    ...
    assert match_category_label("Documentation", categories) == "Documentation"
...
def test_match_category_label_uses_slug_and_partial_matches() -> None:
    ...
    assert match_category_label("Reasoning Debugging", categories) == "Reasoning / Debugging"
    assert match_category_label("debugging", categories) == "Reasoning / Debugging"


def test_match_category_label_returns_none_when_unknown() -> None:
    categories = [_category("refactoring", "Refactoring")]
    assert match_category_label("Observability", categories) is None
